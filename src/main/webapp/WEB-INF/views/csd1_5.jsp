...
<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="#">CSD1.5</a>
   ...
   <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">AITI-KACE CSD1.5 STUDENT DETAILS</h1>
          </div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="addCsd1_5Student" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="course">
										<option value="Certificate in Software Development(CSD1.5)">Certificate in Software Development(CSD1.5)</option>
									</select>
								</div>
...
<button class="btn btn-primary text-light btn-outline-success"  data-toggle="collapse" data-target="#coll">View Results</button>    
	...
	<tbody>
			...
			<c:forEach items="${students}" var="student">
				...
				<c:url value="/studentInfo/updateCsd1_5StudentInfo" var="updateURL">
					...
					<c:url value="/studentInfo/deleteCsd1_5StudentInfo" var="deleteURL">
					<c:param name="student_id" value="${student.student_id }"></c:param>
				</c:url>
...
<div id="coll" class="collapse">
 ...
 <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">AITI-KACE CSD1.5 STUDENT RESULTS </h1>
          </div>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
	...
	<tbody>
			...
			<c:forEach items="${studentResults}" var="csd1_5StudentResults">

				<c:url value="/studentInfo/updateCsd1_5StudentResult" var="updateURL">
					<c:param name="id" value="${csd1_5StudentResults.id }"></c:param>
					<c:param name="student_id" value="${csd1_5StudentResults.student_id }"></c:param>
					<c:param name="foc" value="${csd1_5StudentResults.foc }"></c:param>
					<c:param name="html_css" value="${csd1_5StudentResults.html_css }"></c:param>
					<c:param name="javascript" value="${csd1_5StudentResults.javascript }"></c:param>
					<c:param name="se" value="${csd1_5StudentResults.se }"></c:param>
					<c:param name="database_tec" value="${csd1_5StudentResults.database_tec }"></c:param>
					<c:param name="python" value="${csd1_5StudentResults.python }"></c:param>
				</c:url>
	

	
					<c:url value="/studentInfo/deleteCsd1_5StudentResult" var="deleteURL">
					<c:param name="student_id" value="${csd1_5StudentResults.student_id }"></c:param>
				</c:url>


				<tr><td>${csd1_5StudentResults.id }</td>
					<td>${csd1_5StudentResults.student_id }</td>
					<td>${csd1_5StudentResults.foc }</td>
					<td>${csd1_5StudentResults.html_css }</td>
					<td>${csd1_5StudentResults.javascript }</td>
					<td>${csd1_5StudentResults.se }</td>
					<td>${csd1_5StudentResults.database_tec }</td>
					<td>${csd1_5StudentResults.python }</td>
					<td><a href="${updateURL }"><img src="${pageContext.request.contextPath }/resources/images/Update.png" width="50" height="50"></a> </td>
					<td><a href="${deleteURL }" onclick="if (!confirm('Are you sure you want to delete this student')) return false"><img src="${pageContext.request.contextPath }/resources/images/delete1.png" width="50" height="50"></a></td>
				<tr />
