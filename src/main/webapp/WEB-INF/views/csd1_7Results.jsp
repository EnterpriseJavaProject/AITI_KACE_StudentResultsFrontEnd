...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">ADD AITI-KACE CSD1.7 STUDENT RESULTS</h6>
  </div>
  <div class="card-body">
...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="addCsd1_7StudentResult" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>STUDENT ID</label> <input name="student_id"
										type="text" class="form-control" id="student_id" required>
								...
								<div class="form-group">
									<label>SOFTWARE ENGINEERING</label> <input name="se" type="text"
										class="form-control" id="se" required>
								...
								<div class="form-group">
									<label>ORACLE DATABASE</label> <input name="database_tec" type="text"
										class="form-control" id="database_tec"  required>
								...
								<div class="form-group">
									<label>PYTHON</label> <input name="python" type="text"
										class="form-control" id="python" required>
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-primary" onclick="return validate()" id="sweetalert">Add</button>
								</div>
