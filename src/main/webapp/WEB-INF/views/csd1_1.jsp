...
<li class="nav-item active">
  <a class="nav-link" href="${pageContext.request.contextPath }/aitiStudents/getAllStudentInfo">
  ...
  -->   
	...
	<tbody>
			...
			<c:forEach items="${student}" var="student">
				...
				<c:url value="getCsd1_1StudentById" var="updateURL">
				...
				<c:url value="deleteCsd1_1StudentInfo" var="deleteURL">
				<c:param name="student_id" value="${student.student_id }"></c:param>
				</c:url>
...
<div id="coll" class="collapse">
 ...
 <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">AITI-KACE CSD1.1 STUDENT RESULTS </h1>
          </div>
...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
	...
	<tbody>
			...
			<c:forEach items="${studentResults}" var="csd1_1StudentResults">

				<c:url value="getCsd1_1StudentResultsById" var="updateURL">
					<c:param name="id" value="${csd1_1StudentResults.id }"></c:param>
					<c:param name="student_id" value="${csd1_1StudentResults.student_id }"></c:param>
					<c:param name="foc" value="${csd1_1StudentResults.foc }"></c:param>
					<c:param name="html_css" value="${csd1_1StudentResults.html_css }"></c:param>
					<c:param name="javascript" value="${csd1_1StudentResults.javascript }"></c:param>
					<c:param name="se" value="${csd1_1StudentResults.se }"></c:param>
					<c:param name="database_tec" value="${csd1_1StudentResults.database_tec }"></c:param>
					<c:param name="python" value="${csd1_1StudentResults.python }"></c:param>
				</c:url>
	

	
					<c:url value="deleteCsd1_1StudentResults" var="deleteURL">
					<c:param name="student_id" value="${csd1_1StudentResults.student_id }"></c:param>
				</c:url>


				<tr>
					<td>${csd1_1StudentResults.id }  </td>
					<td>${csd1_1StudentResults.student_id }  </td>
					<td>${csd1_1StudentResults.foc }</td>
					<td>${csd1_1StudentResults.html_css }</td>
					<td>${csd1_1StudentResults.javascript }</td>
					<td>${csd1_1StudentResults.se }</td>
					<td>${csd1_1StudentResults.database_tec }</td>
					<td>${csd1_1StudentResults.python }</td>
