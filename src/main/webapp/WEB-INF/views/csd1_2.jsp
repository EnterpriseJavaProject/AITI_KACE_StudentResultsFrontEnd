   ...
   <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">AITI-KACE CSD1.2 STUDENT DETAILS</h1>
          </div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="addCsd1_2Student" method="post">
...
<button class="btn btn-primary text-light btn-outline-success"  data-toggle="collapse" data-target="#coll">View Results</button>    
	...
	<tbody>
			...
			<c:forEach items="${students}" var="student">
				...
				<c:url value="/studentInfo/updateCsd1_2StudentInfo" var="updateURL">
					...
					<c:url value="/studentInfo/deleteCsd1_2StudentInfo" var="deleteURL">
					<c:param name="student_id" value="${student.student_id }"></c:param>
				</c:url>
  ...
  <div class="card-body">
	...
	<tbody>
			...
			<c:forEach items="${studentResults}" var="csd1_2StudentResults">
				...
				<c:url value="/studentInfo/updateCsd1_2StudentResult" var="updateURL">
					...
					<c:url value="/studentInfo/deleteCsd1_1StudentResult" var="deleteURL">
					<c:param name="student_id" value="${csd1_2StudentResults.student_id }"></c:param>
				</c:url>


				<tr><td>${csd1_2StudentResults.id }</td>
