...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="editCsd1_3StudentInfo" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>STUDENT NAME</label> <input name="student_name"
										type="text" class="form-control" value="${param.student_name}" required>
								</div>
								...
								<div class="form-group">
									<label>EMAIL</label> <input name="email" type="email"
										class="form-control" value="${param.email}" required>
								</div>
