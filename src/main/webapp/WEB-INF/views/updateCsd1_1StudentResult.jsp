...
<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="#">CSD1.1</a>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item" href="adminLogin.html" data-toggle="modal" data-target="#logoutModal">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">UPDATE AITI-KACE STUDENT RESULTS</h6>
  </div>
  <div class="card-body">
...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="updateCsd1_1StudentResults" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>FUNDAMENTALS OF COMPUTING</label> <input name="foc"
										type="text" class="form-control" id="foc" value="${param.foc}" required>
										<span id="foc_error_message" style="color:red;"></span>
								</div>

								<div class="form-group">
									<label>HTML / CSS</label> <input name="html_css" type="text"
										class="form-control" id="html_css" value="${param.html_css}" required>
										<span id="html_css_error_message" style="color:red;"></span>
								</div>

								<div class="form-group">
									<label>JAVASCRIPT</label> <input name="javascript" type="text"
										class="form-control" id="javascript" value="${param.javascript}" required>
										<span id="javascript_error_message" style="color:red;"></span>
								</div>


								<div class="form-group">
									<label>SOFTWARE ENGINEERING</label> <input name="se" type="text"
										class="form-control" id="se" value="${param.se}" required>
										<span id="se_error_message" style="color:red;"></span>
								</div>

								
								<div class="form-group">
									<label>ORACLE DATABASE</label> <input name="database_tec" type="text"
										class="form-control" id="database_tec" value="${param.database_tec}" required>
										<span id="database_tec_error_message" style="color:red;"></span>
								</div>
								
								
								<div class="form-group">
									<label>PYTHON</label> <input name="python" type="text"
										class="form-control" id="python" value="${param.python}" required>
										<span id="python_error_message" style="color:red;"></span>
								</div>

								<div class="modal-footer">
									<button type="submit" onclick="return validate()"><img src="${pageContext.request.contextPath }/resources/images/Update.png" width="50" height="50"></button>
									<a href="${pageContext.request.contextPath }/aitiStudents/getCsd1_1Page"><img src="${pageContext.request.contextPath }/resources/images/back.jpeg" width="50" height="50"></a>
								</div>
