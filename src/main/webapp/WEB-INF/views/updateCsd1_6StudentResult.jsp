...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="editCsd1_6StudentResult" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>FUNDAMENTALS OF COMPUTING</label> <input name="foc"
										type="text" class="form-control" value="${param.foc}" required>
								</div>

								<div class="form-group">
									<label>HTML / CSS</label> <input name="html_css" type="text"
										class="form-control" value="${param.html_css}" required>
								</div>

								<div class="form-group">
									<label>JAVASCRIPT</label> <input name="javascript" type="text"
										class="form-control" value="${param.javascript}" required>
								</div>


								<div class="form-group">
									<label>SOFTWARE ENGINEERING</label> <input name="se" type="text"
										class="form-control" value="${param.se}" required>
								</div>

								
								<div class="form-group">
									<label>ORACLE DATABASE</label> <input name="database_tec" type="text"
										class="form-control" value="${param.database_tec}" required>
								</div>
								
								
								<div class="form-group">
									<label>PYTHON</label> <input name="python" type="text"
										class="form-control" value="${param.python}" required>
								</div>

								<div class="modal-footer">
									<button type="submit"><img src="${pageContext.request.contextPath }/resources/images/Update.png" width="50" height="50"></button>
									<a href="${pageContext.request.contextPath }/studentInfo/getCsd1_6Page"><img src="${pageContext.request.contextPath }/resources/images/back.jpeg" width="50" height="50"></a>
								</div>
