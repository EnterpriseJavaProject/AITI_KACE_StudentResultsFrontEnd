...
<title>CSD1.1 Student Results Page</title>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">ADD AITI-KACE CSD1.1 STUDENT RESULTS</h6>
  </div>
  <div class="card-body">
...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form:form action="addCsd1_1StudentResult" method="post" modelAttribute="csd1_1StudentIdRetrival">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<form:input path="student_id" readonly="true" value="${csd1_1StudentIdRetrival.student_id }" class="form-control" />
								</div>
								...
								<div class="form-group">
									...
									<form:input path="foc" class="form-control" id="foc" value="" required="required"/>
									<span id="foc_error_message" style="color:red;"></span>
								</div>

								<div class="form-group">
									<label>HTML / CSS</label> 
									<form:input path="html_css" class="form-control" value="" id="html_css" required="required"/>
								...
								<div class="form-group">
									...
									<form:input path="se" class="form-control" value="" id="se" required="required"/>
								...
								<div class="form-group">
									...
									<form:input path="database_tec" class="form-control" value="" id="database_tec" required="required"/>
								...
								<div class="form-group">
									<label>PYTHON</label> 
									<form:input path="python" class="form-control" value="" id="python" required="required"/>
