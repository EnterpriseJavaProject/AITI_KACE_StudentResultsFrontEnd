        ...
        <div class="row">
          ...
          <div class="col-lg-12">
              ...
              <div class="social-icons">
                    <img src="${pageContext.request.contextPath }/resources/images/fb1.png">
                    <img src="${pageContext.request.contextPath }/resources/images/google1.png">
                    <img src="${pageContext.request.contextPath }/resources/images/twitter.jpg">
                    <!-- <img src="images/whatsapp icon.jpg"> -->
                    <!-- <img src="images/instagram2.jpeg"> -->
                </div>


              <form class="user" action="studentLogin" method="POST">
